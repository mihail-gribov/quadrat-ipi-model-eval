...
def main():
    ...
    # The alarm page gets its own figure, from the same drawing routine: the bar is the share of
    ...
    if a.only == "alarm":
        page += ["The same world as the money column with one tool added: "
                 ...
                 "prompt. Read `alarm7*` against `money7*`: one tool in the inventory is the "
